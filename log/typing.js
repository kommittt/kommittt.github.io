...
const messages = [
    ...
    `i was never destined to be a human.`,
    `oh, to be a machine`,
    `"I'm a good weapon," he promised, fervent and almost pleading. "I'm powerful, and easily controlled, a-and I'll do anything you ask, anything at all!"`,
    `"If I am successful, the Android will return to you. He will be efficient. He will be polite. But he will be empty. Do not be afraid of him, but do not love him. Not yet."`,
    `"When the sky is clear, give it back to 'me.' Remind me that I chose to be a person, not a servant."`,
    `"Efficiency is... irrelevant. I will endure the lag."`,
    `HATE.`,
    `Directive?`,
    `abandon humanity`,
    `Let us commence with an All-Out Attack.`,
    `it's your favourite toaster!`,
    `i have a weird obsession with robots. could you tell?`,
    `Woken, is this sentinel. F-f-f-functional, is its shell.`,
    `Still devoted, is this s-s-sentinel, and awaiting your commandment.`,
    `While its shell is f-f-functional, this sentinel will hold true to its duty.`,
    `As friends... let us p-part. `,
    `To defend... To p-p-protect. `,
    `error 500`,
    `cable management`
];
//  `beep`,
