...
/* highkeniunely sttupid */
var messages = [
    `line... undefined?`,
    `i dont know what im doing anymore!`,
    `okay ❤ yay ❤`,
    `<span class="tokipona">toki a</span>`,
    ...
    `hello vro`,
    `twinnemskibiliciouspie`,
    `:(`,
    `don't forget to feed paul!`,
    `is funkinosc v3 out yet?!`,
    `/imc`,
    ...
    `dysfunctional for 8 years and counting`,
    `rawdoggin life`,
    `chickne snaddich`,
    ...
    `not family friendly!`,
    `that's crazy`,
    `<span class="dealer">Now, me and you, we are dancing on the edge of life and death.<br>Are you ready?</span>`,
    `uscore?`,
    ...
    `<span class="tokipona">kijetesantakalu</span>`,
    ...
    `<span class="balatro">jimbo was here</span>`,
    ...
    `also check out https://asterirving.vercel.app/ !`,
    ...
    `Sdimbt?`,
    `Sybau? 💔`,
    `>i hope i can forget you so i can finally be free from you`,
    ...
    `i can't handle serious emotions without turning them into a joke or immediately running away from it`,
    ...
    `YOUR LIFE IS YOURS`,
    `help i havent touched this site in ages`,
    `how do you code again?`,
    `where did you fall, where did you fall?`,
    `i've seen you fall from where we are`,
    `and it stops and it starts and it stops and it starts`,
    `ive got this feeling ive yet to shake, and i dont know how much more of this feeling i can take`,
    `before i chip, chip, chip - like an old decaying paint`,
    `seems im not the man i swore to be`,
    `so even if its fake, ill pave away the pain, and thats a guarantee-e-e!`,
    `im slowly, growing ever lonely, worst of all the only, perp at fault is me-me-me!`,
    `dustcutter!`,
    `lyrics splash text update just dropped`,
    `is anyone there? oh- hi!`,
    `why does ao3 have "improper use of labubu" as a tag`,
    `accidentally typed aria meth`,
    `i still miss technoblade man`,
    `skibidi zenci`,
    `Louise sees future`,
    `also watch tenet!`,
    `His greed sickens me. Why is he surrounded by so many Aprils? He does not need that many.`,
    `It's Otum. green be. Back Soon`,
    `woke quiz`,
    `if i had a dollar i'd buy an apply juice`,
    `you say too late to start, got your heart in a headlock, i don't believe any of it`,
    `"i wonder if its possible to solve a 2x2 while its inside of you"`,
    `"okay so im bored and currently sucking on some balls"`,
    `shocker . the gay guy likes men . who woulda thunk .`,
    `i hope you enjoy the next 24 hours of your life`,
    `"im gonna bathe and no labubus will be involved"`,
    `pov... im your cereal bowl`,
    `"i was given a halloweenie"`,
    `"moda came twice this round"`,
    `sorry >~< its all over the screen`,
    `why is there ass talk`,
    `what the hell is that fruit passionate about`,
    `bro this fire so hot people who do gender reveals get envious`,
    `cock tuah`,
    `denial stages finally fading`,
    `theres penice. a lot of penice`,
    `this cats name is glans penis look him up on wikipedia`,
    `who out here sending dick pics to wikipedia`,
    `oh great heavens`,
    `emorgi`,
    `"i prefer my betas unclothed"`,
    `stop saying guac and balls stop it stop it stop it`,
    `"getting me all freaked up wont get you back"`,
    `"im not old, chess just took too long"`,
    `"you won't see the light of heaven." "good? i dont think theyll like me up there anyways`,
    `"friendly reminder that its NOT gay if it has 'fem' in the name"`,
    `do you have ibuprofen? i have a headache`,
    `starting off 2026 by being incredibly washed and hella chopped (like usual)`,
    `dj toenail strikes again`,
    `hog ridaa`,
    `i was going to write something here but i forgot`,
    `bring back personal websites!`,
    `make your own personal space in the internet!`,
    `i miss my twin`,
    `the earth took its final breath.`,
    `Wa ha ha!`,
    `by your side`,
    `a home for flowers`,
    `why tf are we in hardcore mode this is so unfair`,
    `wanna work on my mod?`,
    `best viewed in firefox and on desktop!`,
    `im jokimg`,
    `a character that will be creative!`,
    `yet another generic Cwebsite`,
    `bagel shall live on in everyones hearts`,
    `uwa! so heats`,
    `findhim.ogg`,
    `Can you hear me?`,
    `one day...`,
    `remember me`,
    `no bots except for me allowed!`,
    `joker poker balala`,
    `protogens are cool!`,
    `who...?`,
    `deathmatch!`,
...
//  `<span class="tokipona">SITELENPONA</span>`,
...
function cockandballs() {
    ...
    clickSplash.addEventListener("click", function() {
        var rText = Math.floor(Math.random() * messages.length);
        if (rText === 0) {
            document.getElementById("randomsplash").innerHTML = `line ${noMoreManualEditing}!`;
        }
        else {
            document.getElementById("randomsplash").innerHTML = messages[rText];
        }
...
function onClick() {
    clicks += 1;
    noMoreManualEditing = messages.length;
    
    if (clicks === 10) {
        document.getElementById("clickyTxt").innerHTML = `kommittt © 2025. Not A Corporation. All nights reserved?`;
    }
    if (clicks === 25) {
        document.getElementById("clickyTxt").innerHTML = `kommittt © 20<a id="clicks">25</a>. Not A Corporation. All nights reserved.`;
    }
    if (clicks === 50) {
        document.getElementById("clickyTxt").innerHTML = `kommittt © 20<a id="clicks">50</a>. impressive. All nights reserved.`;
    }
    if (clicks === 75) {
        document.getElementById("clickyTxt").innerHTML = `kommittt © 20<a id="clicks">75</a>. you really like clicking this, don't you?`;
    }
    if (clicks === 100) {
        document.getElementById("clickyTxt").innerHTML = `<a id="clicks">100</a>... are you even having fun?`;
    }
    if (clicks === 150) {
        document.getElementById("clickyTxt").innerHTML = `you clicked it <a id="clicks">150</a> times. congratulations, you saw about 1/5th of the splash texts by now, if none of them repeated!`;
    }
    if (clicks === 200) {
        document.getElementById("clickyTxt").innerHTML = `i respect the dedication, at least. how long have you even been here..? `;
    }
    if (clicks === 300) {
        document.getElementById("clickyTxt").innerHTML = `heres your counter back --&gt; <a id="clicks">250</a> did you miss it?`;
    }
    if (clicks === 325) {
        document.getElementById("clickyTxt").innerHTML = `are you even reading the splash texts anymore? yawn...`;
    }
    if (clicks === 350) {
        document.getElementById("clickyTxt").innerHTML = `mind if i sleep a little? won't take long, i promise...`;
    }
    if (clicks === 360) {
        document.getElementById("clickyTxt").innerHTML = `zzz...`;
    }
    if (clicks === 370) {
        document.getElementById("clickyTxt").innerHTML = `zzzz...`;
    }
    if (clicks === 380) {
        document.getElementById("clickyTxt").innerHTML = `zzzzz...`;
    }
    if (clicks === 390) {
        document.getElementById("clickyTxt").innerHTML = `zzzzzz...`;
    }
    if (clicks === 400) {
        document.getElementById("clickyTxt").innerHTML = `zzzzzzz...`;
    }
    if (clicks === 410) {
        document.getElementById("clickyTxt").innerHTML = `zzzzzzzz...`;
    }
    if (clicks === 420) {
        document.getElementById("clickyTxt").innerHTML = `yawn... good morning. youre at click <a id="clicks">420</a>!`;
    }
    if (clicks === 450) {
        document.getElementById("clickyTxt").innerHTML = `<a id="clicks">450</a> | you know you're kinda wasting your time here, right?`;
    }
    if (clicks === 475) {
        document.getElementById("clickyTxt").innerHTML = `<a id="clicks">475</a> | since youve been here for so long, heres something fun: theres ${noMoreManualEditing} lines of splashes!`;
    }
    if (clicks === 500) {
        document.getElementById("clickyTxt").innerHTML = `wow.. half a thousand clicks. im starting to think youre a little insane.`;
    }
    if (clicks === 501) {
        document.getElementById("clickyTxt").innerHTML = `<a id="clicks">501</a> | hm.. kinda running out of things to say here`;
    }
    if (clicks === 525) {
        document.getElementById("clickyTxt").innerHTML = `kommittt © 2025. Not A Corporation. All nights reserved.`;
    }
    if (clicks === 530) {
        document.getElementById("clickyTxt").innerHTML = `just kidding`;
    }
    if (clicks === 531) {
        document.getElementById("clickyTxt").innerHTML = `<a id="clicks">531</a>...`;
    }
    if (clicks === 550) {
        document.getElementById("clickyTxt").innerHTML = `click if stupid`;
    }
    if (clicks === 551) {
        document.getElementById("clickyTxt").innerHTML = `aha! you really ARE am idiot. (in the flowey voice)`;
    }
    if (clicks === 560) {
        document.getElementById("clickyTxt").innerHTML = `<a id="clicks">560</a> | once you reload, it'll all be reset again, you know?`;
    }
    if (clicks === 600) {
        document.getElementById("clickyTxt").innerHTML = `<a id="clicks">600</a> | and yet you keep going...`;
    }
    if (clicks === 615) {
        document.getElementById("clickyTxt").innerHTML = `<a id="clicks">615</a> | you humans are funny`;
    }
    if (clicks === 650) {
        document.getElementById("clickyTxt").innerHTML = `<a id="clicks">650</a> | im afraid our time here is over.`;
    }
    if (clicks === 660) {
